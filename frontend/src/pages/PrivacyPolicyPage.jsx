            ...
            <>
              ...
              <div className="border-b border-gray-200 pb-6 mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h1 className="text-4xl font-bold text-gray-900">{privacyPolicy.title}</h1>
                </div>
                ...
                <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>Effective Date: {formatDate(privacyPolicy.effectiveDate)}</span>
                  </div>
                  {privacyPolicy.updatedAt && (
                    <div className="flex items-center gap-2">
                      <Calendar className="w-4 h-4" />
                      <span>Last Updated: {formatDate(privacyPolicy.updatedAt)}</span>
                    </div>
                  )}
                </div>
              </div>
